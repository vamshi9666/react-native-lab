            ...
            cond(eq(this.forwardComplete, 1), [
              call([], () => {
                requestAnimationFrame(() => {
                  ...
                  // alert(" push last " + this.state.objToBeUpdatedForRightSwipe);
        ...
        >
          ...
          >
            <A.View style={{}}>
              ...
              >
                {/*<ReText text={concat("las one  ", this.valueToPushFirst)} />*/}
              </View>
